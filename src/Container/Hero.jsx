        ...
        <section className="hero relative md:grid grid-cols-2 h-[600px] md:container max-w-full">
         <div className="shadowy">
            <div className="md:my-36 my-28 pl-4 md:pl-20 absolute">
                ...
                <p className="font-bold text-base md:text-[18px] text-[15px] text-white md:text-Paragraph my-8">Connect with trusted cleaning professinals instantily. Book, Chat and pay securely, all in one place.
                </p>

                <div className="bg-white rounded-full flex items-center justify-between p-3 shadow-md shadow-gray-300 md:w-[500px] w-[320px]">
